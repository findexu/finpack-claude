...
|-------------------------------|--------------------|--------------------|------------------|
| `CLAUDE.md`                   | <25 non-blank lines | <50 non-blank lines | Trim per Phase 4 of `/setup-finpack`. |
...
- Hooks contribute to context only if they print to stdout. finpack-claude's hooks are silent on success by design.
